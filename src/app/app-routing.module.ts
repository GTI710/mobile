...
const routes: Routes = [
  ...
  { path: '1/5/', loadChildren: './components/bas-uniforme/bas-uniforme.module#BasUniformePageModule' },
  { path: '1/6/', loadChildren: './components/bas-halloween/bas-halloween.module#BasHalloweenPageModule' },
  { path: '1/7/', loadChildren: './components/bas-cabane-asucre/bas-cabane-asucre.module#BasCabaneASucrePageModule' },
  { path: '1/8/', loadChildren: './components/bas-saint-valentin/bas-saint-valentin.module#BasSaintValentinPageModule' },
